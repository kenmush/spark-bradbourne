        ...
        <div class="card-body">
            ...
            <form role="form">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control" name="type"  v-model="user.type" :class="{'is-invalid': form.errors.has('type')}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control" name="category"  v-model="user.category" :class="{'is-invalid': form.errors.has('category')}">
